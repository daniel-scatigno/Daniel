...
namespace NCPC.Utils
{
   public class SendMail
   {
         ...
         , List<Attachment> attachments = null, List<AlternateView> alternateViews = null)
      {
         ...
         if (perfil == null) throw new Exception($"{SfResources.PerfilEmailNaoCadastrado}!");
         ...
         if (IsDevelopment)
         {
            destinatarios = new List<string>() { "daniel.scatigno@ncpc.com.br", "bruno.lima@ncpc.com.br" };
         }
         ...
         smtpClient.Credentials = new NetworkCredential(perfil.Usuario, NCPC.Utils.EncryptUtils.Decrypt(perfil.Senha));
